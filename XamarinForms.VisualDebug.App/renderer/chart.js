...
var orgChart = (function () {
	var _margin = {
		...
		initTree = function (options) {
			...
			var height = $(id).innerHeight() - _margin.top - _margin.bottom;
...
//orgChart.initTree({ id: "#body", data: u_data, modus: "diagonal", loadFunc: loadChilds });

module.exports = {
	initTree(params) {
		initTree({ treedata: params.data, modus: params.modus, loadFunc: params.loadFunc, id: params.id });
	}
};
