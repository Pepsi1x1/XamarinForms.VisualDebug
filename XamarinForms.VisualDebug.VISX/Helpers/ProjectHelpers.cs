...
namespace XamarinForms.VisualDebug.VsixExtension.Helpers
{
    internal static class ProjectHelpers
    {
        ...
        public static Project GetSolutionItemsProject()
        {
            ...
            Solution2 solution = VISXPackage.DTE.Solution as Solution2;
        ...
        public static IEnumerable<Project> GetAllProjects()
        {
            ...
            return VISXPackage.DTE.Solution.Projects
                  .Cast<Project>()
                  .SelectMany(GetChildProjects)
                  .Union(VISXPackage.DTE.Solution.Projects.Cast<Project>())
        ...
        public static string GetRootFolder(Project project = null)
        {
            ...
            try
            {
                ...
                {
                    var doc = VISXPackage.DTE.ActiveDocument;
        ...
        public static Project GetActiveProject()
        {
            try
            {
                Array activeSolutionProjects = VISXPackage.DTE.ActiveSolutionProjects as Array;
        ...
        public static IEnumerable<string> GetSelectedItemPaths(DTE2 dte = null)
        {
            ...
            var items = (Array)(dte ?? VISXPackage.DTE).ToolWindows.SolutionExplorer.SelectedItems;
        ...
        public static IEnumerable<Project> GetSelectedProjects()
        {
            ...
            var items = (Array)VISXPackage.DTE.ToolWindows.SolutionExplorer.SelectedItems;
        ...
        public static string GetSolutionFolderPath()
        {
            ...
            Solution solution = VISXPackage.DTE.Solution;
        ...
        internal static ProjectItem GetProjectItem(string fileName)
        {
            ...
            try
            {
                return VISXPackage.DTE.Solution.FindProjectItem(fileName);
            }
